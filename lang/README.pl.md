...
Biblioteka dzielona napisana w C++, która umożliwia parsowanie formatu JSON z pliku lub stringu, funkcjonalnie odpowiednik biblioteki Pythonowej.

Ten projet wykorzystuje namespace ```json```
